...
\textbf{Pregunta 5: reproducibilidad distribuida.} La campaña real conserva 120 filas únicas, las 24 condiciones con cinco repeticiones, 60 segundos de calentamiento, 90 segundos de medición y concurrencias efectivamente alcanzadas. Se ejecutó a través del Gateway y los microservicios sobre CockroachDB. La reproducibilidad estructural queda acreditada por \path{validacion.json}; el resultado comparativo sigue siendo inconcluso porque únicamente tres checkouts fueron confirmados.
