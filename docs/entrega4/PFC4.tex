...
\newcommand{\evidencia}[2]{\href{https://github.com/JoseLozanoMorales/TiendaTech/blob/e6680b0290d2c6921ea47116c2df60bd7b055de0/#1}{#2}}
...
El corte documental integra las evidencias publicadas hasta el commit \texttt{e6680b0}, cuyo hash completo fijan los enlaces de evidencia. Incluye la campaña distribuida, la evaluación ISO, las pruebas de CI, el panel Grafana y las trazas incorporadas hasta el 4 de septiembre de 2026. Cada resultado conserva su procedencia y unidad experimental; el cierre de esta memoria no equivale a declarar aprobados los pasos técnicos que permanecen como deuda.
