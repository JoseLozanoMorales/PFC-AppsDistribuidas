...
Para reproducir el PDF desde un clon deben estar incluidos el logo \path{UteqLogo.png}, las imágenes utilizadas de \path{img/} y las dos figuras \path{cierre/boxplot-p95.png} y \path{cierre/spark-t1.png}. Regenerar estas últimas requiere además el script y sus CSV. Su presencia local no implica que estén versionados: antes de publicar, debe comprobarse que esas dependencias estén incorporadas al repositorio.
