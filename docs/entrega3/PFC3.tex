...
\bottomrule
    ...
    \section{Modelado Arquitectónico mediante Diagramas C4}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{diagramas/C4-L1.jpeg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{../../../docs/diagrams/tiendatech-c4-l2.drawio.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{../../../docs/diagrams/tiendatech-c4-l3-checkout.drawio.png}
...
\bottomrule
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{../../../docs/diagrams/tiendatech-despliegue.drawio.png}
