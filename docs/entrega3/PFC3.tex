...
La implementación realizada permitió validar el funcionamiento del sistema distribuido TiendaTech mediante la integración de los microservicios, la comunicación entre ellos y la ejecución satisfactoria del flujo transaccional principal. Las pruebas efectuadas confirmaron el cumplimiento de los objetivos planteados para esta etapa, evidenciando un comportamiento funcional y tiempos de respuesta acordes con los criterios definidos. Como trabajo futuro, se plantea fortalecer la arquitectura mediante mecanismos de persistencia distribuida, pruebas bajo escenarios de mayor concurrencia y la incorporación de capacidades que amplíen la escalabilidad y tolerancia a fallos del sistema.
