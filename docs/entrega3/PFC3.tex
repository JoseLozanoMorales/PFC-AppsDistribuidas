...
volumes:
  ...
  vol_db_ordenes:
    ...
    El desarrollo de plataformas modernas de comercio electrónico optimizadas para la configuración de productos complejos ha impulsado una notable evolución en la literatura científica. A continuación, se presenta una síntesis integradora de los enfoques metodológicos actuales, estructurada mediante el mapeo de problemas y tecnologías de vanguardia indexadas entre los años 2020 y 2026.

    \subsection{Mapeo de Problemas y Enfoques Metodológicos}

    En la capa de persistencia, la literatura reciente confirma que la estrategia de particionamiento debe responder tanto a la distribución de los datos como al patrón de acceso. \textcite{kang2021jigsaw} proponen particiones irregulares orientadas por la carga para reducir lecturas redundantes, mientras que \textcite{zhou2023grep} automatizan la selección de claves de particionado mediante aprendizaje sobre grafos. Desde la perspectiva de verificación, \textcite{rigger2020querypartitioning} demuestran que la partición equivalente de consultas permite descubrir errores lógicos en gestores como CockroachDB. Estudios aplicados complementarios comparan particionamiento horizontal, vertical, por rango, hash e híbrido en almacenes cloud y lagos de datos, destacando sus efectos sobre latencia, paralelismo y consumo de recursos \cite{anala2024scalable,gundapaneni2025partitioning,katari2023datalakes}.
